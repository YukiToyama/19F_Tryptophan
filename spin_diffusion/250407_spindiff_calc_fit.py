...
#ax.plot(time,Imag/thermal[1],  markeredgewidth=0.5, color='white',linewidth=0.,
#         markeredgecolor="black", marker='o', markersize=1.5)
ax.plot(time, recovery(time, R1, M0), color="magenta",ls="--",linewidth=0.4,
        label = "$R_{1,fit}$ ="+str(round(R1,2))+" [s$^{-1}$]")
...
#ax.text(0.3,0.2,"$R_{1,fit}$ = %.2e"%  
#   (R1),transform=ax.transAxes,va="top",fontsize=6)
ax.legend(fontsize=4,loc='lower right')
   
ax = fig1.add_subplot(132)

ax.plot(time,Smag/thermal[2], color="black",linewidth=0.4)
#ax.plot(time,Smag/thermal[2],  markeredgewidth=0.5, color='white',linewidth=0.,
#         markeredgecolor="black", marker='o', markersize=1.5)
...
if len(Dist)>2:
    ...
    ax.plot(time,Kmag/thermal[3], color="black",linewidth=0.4)
    #ax.plot(time,Kmag/thermal[3],  markeredgewidth=0.5, color='white',linewidth=0.,
    #         markeredgecolor="black", marker='o', markersize=1.5)
